...
func (o *CreateAppCreated) WithPayload(payload string) *CreateAppCreated {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create app created response
func (o *CreateAppCreated) SetPayload(payload string) {
	o.Payload = payload
}
...
/*CreateAppDefault Internal server error
